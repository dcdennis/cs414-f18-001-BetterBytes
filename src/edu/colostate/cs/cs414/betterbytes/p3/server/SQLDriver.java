...
public class SQLDriver {
	...
	public Account getAccount(String requestUser) {
		...
		// and frankly I dont want to try and trace the path backwords and fix
		// everything, this is easier
		return null;
	}
	...
	public void addGame(Player attacker, Player defender, Game gameUpdate) {
		// TODO updates a game. like the ones you already have, just with a serialized
		// game object.
