...
public class RulesEngine {
	...
	public GameResult gameHasEnded(Game game)
	{
		...
		if(	game.getCell(0, 0).hasPiece() || game.getCell(0,10).hasPiece() ||
				game.getCell(10, 0).hasPiece() || game.getCell(10, 10).hasPiece())
		...
		if(kingLoc.getX() == 0)
		{
			if(	game.getCell(1, kingLoc.getY()).hasPiece() && !game.getCell(1, kingLoc.getY()).getPiece().isWhite() &&
				game.getCell(0, kingLoc.getY()+1).hasPiece() && !game.getCell(1, kingLoc.getY()).getPiece().isWhite() &&
				game.getCell(0, kingLoc.getY()-1).hasPiece() && !game.getCell(1, kingLoc.getY()).getPiece().isWhite() &&
				this.kingAlone(game))
				return GameResult.BLACK;
		}
		if(kingLoc.getX() == 10)
		{
			if(	game.getCell(9, kingLoc.getY()).hasPiece() && !game.getCell(1, kingLoc.getY()).getPiece().isWhite() &&
					game.getCell(10, kingLoc.getY()+1).hasPiece() && !game.getCell(1, kingLoc.getY()).getPiece().isWhite() &&
					game.getCell(10, kingLoc.getY()-1).hasPiece() && !game.getCell(1, kingLoc.getY()).getPiece().isWhite() &&
					this.kingAlone(game))
					return GameResult.BLACK;
		}
		if(kingLoc.getY() == 0)
		{
			if(	game.getCell(kingLoc.getX(), 1).hasPiece() && !game.getCell(kingLoc.getX(), 1).getPiece().isWhite() &&
					game.getCell(kingLoc.getX()+1, 0).hasPiece() && !game.getCell(kingLoc.getX()+1, 0).getPiece().isWhite() &&
					game.getCell(kingLoc.getX()-1, 0).hasPiece() && !game.getCell(kingLoc.getX()-1, 0).getPiece().isWhite() &&
					this.kingAlone(game))
					return GameResult.BLACK;
		}
		if(kingLoc.getY() == 10)
		{
			if(	game.getCell(kingLoc.getX(), 9).hasPiece() && !game.getCell(kingLoc.getX(), 9).getPiece().isWhite() &&
					game.getCell(kingLoc.getX()+1, 10).hasPiece() && !game.getCell(kingLoc.getX()+1, 10).getPiece().isWhite() &&
					game.getCell(kingLoc.getX()-1, 10).hasPiece() && !game.getCell(kingLoc.getX()-1, 10).getPiece().isWhite() &&
					this.kingAlone(game))
					return GameResult.BLACK;
		}
