        ...
        while result(currentState) == "continue" and numMoves < 2000:
            ...
            if(numMoves == 0):
                if(captures > 0):
                    ...
                    Q[boardMoveTuple(oldState,pickedMove,turn)] =  Q.get(boardMoveTuple(oldState,pickedMove,turn),0) +  10
                else:
                    Q[boardMoveTuple(oldState,pickedMove,turn)] =  Q.get(boardMoveTuple(oldState,pickedMove,turn),0) + 0
            else:
                if(captures > 0):
                    #print("CAP: ", pickedMove)
