...
public class AIClient {
	...
	static String path = currentRelativePath.toAbsolutePath().toString() + "/edu/colostate/cs/cs414/betterbytes/p3/client/";
	...
	IllegalAccessException, UnsupportedLookAndFeelException, IOException, InterruptedException 
	{
		try 
		{
			...
			Thread.sleep(1000);
			//UserLogonResponse loginResponse = (UserLogonResponse) connection.send(new UserLogon("AIUSER","AILOGON"));
