...
public class Piece {
	...
	public Image king = Tools.getLocalImg(absPath+"edu/colostate/cs/cs414/betterbytes/p4/client/data/pieces/white_king.png");
	public Image[] rooks = {
			Tools.getLocalImg(absPath+"edu/colostate/cs/cs414/betterbytes/p4/client/data/pieces/black_rook.png"),
			Tools.getLocalImg(absPath+"edu/colostate/cs/cs414/betterbytes/p4/client/data/pieces/white_rook.png") };
